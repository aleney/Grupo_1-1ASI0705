...
import { Tipotienda } from './components/tipotienda/tipotienda';
...
import { Tiporesenainsert } from './models/tiporesenainsert';
...
export const routes: Routes = [
  ...
  { path:'tiporesena',
      ...
      {path:'insertar', component: Tiporesenainsert}
    ],
    //canActivate: [seguridadGuard],
  },
